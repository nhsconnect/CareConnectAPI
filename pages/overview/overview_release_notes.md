...
Updated
  - Reference Implementation guidance to deploy the latest version
  - Updated images

## 2.4.0-alpha.0 ##

Updated
  - Images in Security updates
  - Updated all of the work in progress sections to provide a stable end to end guidance
