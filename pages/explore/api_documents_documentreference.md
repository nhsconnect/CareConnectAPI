...
{% include custom/embedcurl.html title="Search DocumentReference" command="curl -X GET -H 'Accept: application/xml+fhir' -H 'Authorisation: BEARER [token]' -v 'http://yellow.testlab.nhs.uk/careconnect-ri/STU3/DocumentReference?patient=1002'" %}
