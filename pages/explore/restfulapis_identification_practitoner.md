...
{% include custom/embedcurl.html title="Search Practitioner" command="curl -X GET  '[baseUrl]/Practitioner?identifier=https://fhir.nhs.uk/Id/sds-user-id|G8133438&_format=xml'" %}
