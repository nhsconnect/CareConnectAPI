...
| User Story    | Profile     |
| :--- |--------------: |
| As a clinician (hospital Services) I want to include the patient's TTO medications in the discharge summary to provide a complete and accurate list of the patient's medication to the GP. | [GET MedicationStatement ](restfulapis_clinical_medicationstatement.html#2-search-parameters) |
